...
import nuxt_plugin_plugin_31606fe2 from 'nuxt_plugin_plugin_31606fe2' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_44bf3034 from 'nuxt_plugin_bootstrapvue_44bf3034' // Source: .\\bootstrap-vue.js (mode: 'all')
...
import nuxt_plugin_typed_6a64527a from 'nuxt_plugin_typed_6a64527a' // Source: ..\\plugins\\typed.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"maxcoach-vue","titleTemplate":"%s - Dr Joanna Maciejewska","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_31606fe2 === 'function') {
    await nuxt_plugin_plugin_31606fe2(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_44bf3034 === 'function') {
    await nuxt_plugin_bootstrapvue_44bf3034(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_typed_6a64527a === 'function') {
